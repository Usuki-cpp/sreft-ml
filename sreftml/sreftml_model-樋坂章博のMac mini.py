...
import datetime
from src.sreft_ml.sreftml import utilities
...
class SReFT(tf.keras.Model):
    ...
    def __init__(
        ...
        self.only_model_y = only_model_y
    ...
    def call(
        ...
        **kwargs,
        ...
        if self.only_model_y:
            offset = tf.zeros_like(input_x)
            dis_time = input_x
    ...
    def get_config(self):
        ...
        config.update({
            ...
            'only_model_y': self.only_model_y
        })
        return config
